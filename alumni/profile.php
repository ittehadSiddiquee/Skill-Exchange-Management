...
<body>
    ...
    <div class="layout">
        ...
        <div class="main-content">
            <h1>My Profile</h1>
            <p class="subtitle">Update your alumni information</p>
            ...
            <form action="../../controllers/alumni_controller.php" method="POST" class="profile-form">
                ...
                <input type="text" name="graduationYear" id="gradyear_input" value="<?php echo htmlspecialchars($profile['graduationYear']); ?>" placeholder="e.g. 2022">

                <label>Company</label>
                <input type="text" name="company" value="<?php echo htmlspecialchars($profile['company']); ?>" placeholder="e.g. Brain Station 23">

                <label>Industry</label>
                <input type="text" name="industry" value="<?php echo htmlspecialchars($profile['industry']); ?>" placeholder="e.g. Software">

                <label>Preferred Communication</label>
                <input type="text" name="commPreference" value="<?php echo htmlspecialchars($profile['commPreference']); ?>" placeholder="e.g. Email, LinkedIn">

                <h3>About You</h3>

                <label>Bio</label>
                <textarea name="bio" rows="3" placeholder="Tell current students a bit about yourself..."><?php echo htmlspecialchars($profile['bio']); ?></textarea>

                <label>Interests / Skills</label>
                <textarea name="interests" rows="2" placeholder="e.g. Career Guidance, Interview Prep"><?php echo htmlspecialchars($profile['interests']); ?></textarea>
