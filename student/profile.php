...
<body>
    ...
    <div class="layout">
        ...
        <div class="main-content">
            <h1>My Profile</h1>
            <p class="subtitle">Update your personal and academic information</p>
            ...
            <form action="../../controllers/student_controller.php" method="POST" class="profile-form">
                ...
                <input type="text" name="enrollmentNo" value="<?php echo htmlspecialchars($profile['enrollmentNo']); ?>">

                <label>Batch</label>
                <input type="text" name="batch" value="<?php echo htmlspecialchars($profile['batch']); ?>">

                <label>CGPA</label>
                <input type="text" name="cgpa" id="cgpa_input" value="<?php echo htmlspecialchars($profile['cgpa']); ?>" placeholder="e.g. 3.75">

                <h3>About You</h3>

                <label>Bio</label>
                <textarea name="bio" rows="3" placeholder="Tell others a bit about yourself..."><?php echo htmlspecialchars($profile['bio']); ?></textarea>

                <label>Interests / Skills</label>
                <textarea name="interests" rows="2" placeholder="e.g. Python, Web Design, Photography"><?php echo htmlspecialchars($profile['interests']); ?></textarea>
